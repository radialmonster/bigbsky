...
- [ ] **Compose: real post + reply** — wire the placeholder composer and inline reply box to actually publish `app.bsky.feed.post` records (replies set the reply ref). Includes the 300-char validation already present. (Scope granted.)
