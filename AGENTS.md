...
- `docs/PLAN.md` — project plan (design context + history; open work is tracked in GitHub issues).
- `docs/LESSONS.md` — durable lessons/gotchas (things to KNOW; tasks belong in GitHub issues).
- `docs/cloudflare-pages-setup.md` — hosting/deploy setup.
- The rest of `docs/` is per-area reference (architecture, constraints, design-spec, ops, research-findings, HISTORY, oauth-proof; see the Section Index in `docs/PLAN.md`) plus the vendored upstream clones below.
