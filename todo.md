...
- [ ] Standardize composer controls for posts and replies.
  ...
  - Remaining (still open under this task): **GIFs** (Tenor embed flow) and an **emoji picker** — none added yet, on either composer. These are larger (Tenor integration, picker UI) and should verify bsky.app's exact API calls first. Captured as the next steps here.
  - Relevant files/functions found:
